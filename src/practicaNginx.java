/* Generated By:JavaCC: Do not edit this line. practicaNginx.java */
import java.util.Stack;

public class practicaNginx implements practicaNginxConstants {
  ...
  public practicaNginxTokenManager token_source;
  ...
  public practicaNginx(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public practicaNginx(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new practicaNginxTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public practicaNginx(java.io.Reader stream) {
  ...
  public practicaNginx(practicaNginxTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(practicaNginxTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
